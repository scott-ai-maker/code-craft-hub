...
const sendPasswordResetEmail = async (email, username, resetToken) => {
    ...
    const mailOptions = {
        ...
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <p>You requested a password reset for your Code Craft Hub account. Click the button below to reset your password:</p>
                <div style="text-align: center; margin: 30px 0;">
                    <a href="${resetUrl}" 
                       style="background-color: #4CAF50; color: white; padding: 14px 28px; 
                              text-decoration: none; border-radius: 4px; display: inline-block;">
    ...
    if (!transporter) {
        // Log email instead of sending in dev mode without configuration
        logger.info('Password Reset Email (not sent - no config):', {
            to: email,
            subject: mailOptions.subject,
            resetUrl,
        });
